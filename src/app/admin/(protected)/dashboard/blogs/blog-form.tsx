...
import { BlogFormValues, useBlogForm } from "@/hooks/use-blog-form";
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className="space-y-6 pt-6">
            <BlogTitleInput control={form.control} />
            <BlogContentInput control={form.control} />
            <BlogStatusSelect control={form.control} />
            <BlogImageInput
              image={image}
...
function BlogTitleInput({ control }: BlogTitleInputProps) {
  return (
    <FormField
      control={control}
      name="title"
...
function BlogContentInput({ control }: BlogTitleInputProps) {
  return (
    <FormField
      control={control}
      name="content"
...
function BlogStatusSelect({ control }: BlogTitleInputProps) {
  return (
    <FormField
      control={control}
      name="status"
