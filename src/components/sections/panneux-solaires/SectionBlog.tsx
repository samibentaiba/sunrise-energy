  ...
  return (
    <section className="py-8 md:pb-14 px-4 md:px-8 lg:px-50 bg-white">
      ...
      <div className="w-full text-black text-[10px] mt-6 px-4 md:px-0 max-w-7xl mx-auto">
        *Délai moyen d'installation de centrales solaires SunVolt après signature de devis constaté entre le 01/01/2023
        et le 30/05/2023, hors délai de raccordement et de conformité Consuel
      </div>
    </section>
  )
}
