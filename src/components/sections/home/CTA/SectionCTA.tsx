  ...
  return (
    <section className="relative w-full h-[615px] overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        <Image className="absolute w-full object-fill transition-transform duration-0" ref={backgroundRef} src="/images/Castelnau.jpeg" alt="Solar panels installation background" width={1500} height={2000} />
