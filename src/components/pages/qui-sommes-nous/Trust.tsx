...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    text:
      "Très bonne expérience avec l'entreprise, qui nous a bien conseillé et qui a suivi le projet de bout en bout. Très satisfait.",
  },
  {
    name: "Dams",
  ...
  },
  {
    ...
    rating: 5,
    text:
      "Très satisfaite de la personne que j'ai eu au téléphone, il explique bien les choses si on a des questions, on peut les appeler. Je recommande",
  },
  {
    name: "J.p.",
    date: "4 Décembre 2024",
...
const ReviewText = ({
  ...
  const displayText = isExpanded || !shouldTruncate ? text : text.substring(0, PREVIEW_LIMIT) + "..."
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      <div className="flex items-center justify-between mb-3">
        ...
        <Image src="/images/modules/Google.svg" alt="Google" width={24} height={24} />
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-16">
        <div>
          <h2 className="text-3xl md:text-4xl font-bold">
            <span className="bg-yellow-300 px-2 py-1">Merci</span> à nos 3 000 clients pour
