...
const faqData = [
    {
        id: "item-1",
        question: "Le routeur solaire est-il rentable pour une installation photovoltaïque ?",
    ...
    {
        id: "item-2",
        question: "Quels critères prendre en compte pour choisir un routeur solaire ?",
    ...
    {
        id: "item-3",
        question: "Quelle est la différence entre un routeur solaire et un gestionnaire d'énergie ?",
    ...
    {
        id: "item-5",
        question: "Quels sont les avantages d'un routeur solaire pour une installation photovoltaïque ?",
...
export default function SolarRouterFAQ() {
    return (
            ...
            <div className="border-none container mx-auto px-4">
                <div className="border-none grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="border-none md:col-span-1">
                        <h2 className="border-none text-2xl font-bold mb-6">Questions fréquemment posées</h2>
                    </div>

                    <div className="border-none md:col-span-2">
                        <Accordion type="single" collapsible className="border-none space-y-4">
                            {faqData.map(({ id, question, answer }) => (
                                <AccordionItem key={id} value={id} className="border-none hover:text-blue-950 rounded-lg overflow-hidden">
