...
import FeatureList from "./ui/CTA/FeatureList";
...
const ParallaxBackground = () => {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/images/pages/home/CTA.jpeg')" }}
    >
      {/* Overlays */}
  ...
  return (
    <div className="animate-fade-in-up flex max-w-[600px] flex-col gap-10 text-left">
      <h2 className="text-4xl font-medium leading-tight text-shadow">
        Achetez sans risque une installation de panneaux solaires performante
        100% garantie
      </h2>
